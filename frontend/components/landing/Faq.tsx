...
const FAQS = [
  { q: "What exactly am I watching?", a: "A real-time simulation of 20 autonomous AI agents living on a 30×30 grid. Nobody is controlling them — they perceive their surroundings, recall their history, and decide their own actions every half-second." },
  ...
  { q: "Can I influence the outcome?", a: "Not in this build — it's a spectator arena. You can inspect any agent, follow the live event feed, and track the leaderboard, but the society runs entirely on its own." },
  { q: "How long does a run last?", a: "Indefinitely. Agents fall, resources respawn, factions rise and collapse. There's no win condition — just an ongoing world you can drop into at any moment." },
